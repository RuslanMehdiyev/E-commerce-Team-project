    ...
    <div className={testimonCSS.container}>
      <div className={testimonCSS.testimonial}>
        <div className={testimonCSS.person}>
          <span className={testimonCSS.image}><img src={person1}/></span>
          <span className={testimonCSS.fullname}>Savanah Nguyen</span>
        </div>
        <p className={testimonCSS.text}>Lorem ipsum dolor sit amet consectetur. 
      ...
      <div className={testimonCSS.testimonial}>
        <div className={testimonCSS.person}>
          <span className={testimonCSS.image}><img src={person2}/></span>
          <span className={testimonCSS.fullname}>Savanah Nguyen</span>
        </div>
        <p className={testimonCSS.text}>Lorem ipsum dolor sit amet consectetur. 
          Nec sit enim tellus faucibus bibendum ullamcorper. 
      ...
      <div className={testimonCSS.testimonial}>
        <div className={testimonCSS.person}>
          <span className={testimonCSS.image}><img src={person3}/></span>
          <span className={testimonCSS.fullname}>Savanah Nguyen</span>
        </div>
        <p className={testimonCSS.text}>Lorem ipsum dolor sit amet consectetur. 
          Nec sit enim tellus faucibus bibendum ullamcorper. 
